//Minimum deletion of characters to make a string palindromic
...
public class MinimumDeletion {
    ...
    static int minimumDeletion(String s, int n) {
        ...
        return n - longestCommonSubsequence(n, n, s, sRev.toString());
    }

    public static void main(String[] args) {
        String a = "agbcba";

        System.out.println(minimumDeletion(a, a.length()));
    }
}
