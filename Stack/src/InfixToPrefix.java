// Java program to convert the infix expression into prefix expression
...
public class InfixToPrefix {
    ...
    static StringBuilder convertIntoPrefix(StringBuilder infixExpression) {
    ...
    public static void main(String[] args) {
        ...
        infixExpression = convertIntoPrefix(infixExpression.reverse());
        System.out.println(infixExpression);
