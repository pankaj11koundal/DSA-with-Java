...
public class MaxAreaInHistogram {
    ...
    public static long largestRectangleArea(int[] histograms, int n)
    {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Area of the largest histogram / maximum area of histogram is " + largestRectangleArea(histograms, n));
    }
}
